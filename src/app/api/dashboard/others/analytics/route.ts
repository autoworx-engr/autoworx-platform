...
/**
 * @swagger
 * /api/dashboard/others/analytics:
 *   get:
 *     summary: Get others dashboard analytics
 ...
 *     responses:
 *       200:
 *         description: Get others dashboard analytics
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                 message:
 *                   type: string
 *                   example: Get others dashboard analytics
 *                 data:
 *                   type: array
 *                   items:
 *                     type: object
...
export async function GET(req: NextRequest) {
  try {
    ...
    return NextResponse.json({
      success: true,
      message: "Get others dashboard analytics",
      data,
    });
  } catch (error: any) {
    return NextResponse.json(
