...
const TemplateAttachmentTab = () => {
     const { photos, setPhotos,   internalNotes, setInternalNotes,  setCustomerNotes, customerNotes, tasks } = useEstimateCreateStore();  //it will replace with template store later
    return (
        <>
