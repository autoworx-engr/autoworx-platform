import { CheckCircle2, MinusCircle, Clock, ShieldOff, LucideIcon } from "lucide-react";
...
export const STATUS_FILTERS: GiftCardStatusFilter[] = ["ALL", "ACTIVE", "DEPLETED", "EXPIRED", "FROZEN"];
...
export function filterButtonClasses(filter: GiftCardStatusFilter, active: boolean) {
