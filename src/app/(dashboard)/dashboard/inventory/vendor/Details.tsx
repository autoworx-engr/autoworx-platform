...
export default function Details({ vendor }: { vendor: Vendor | undefined }) {
  ...
  return (
    ...
    >
      ...
      <h3 className="text-2xl font-extrabold mb-3" style={{ color: ACCENT_COLOR }}>
        Vendor Details
      </h3>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="pt-4 mt-auto">
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-lg border-2 px-6 py-2.5 font-semibold transition-all duration-200 hover:shadow-md"
              style={{
