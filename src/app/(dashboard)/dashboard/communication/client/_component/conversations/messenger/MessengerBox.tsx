...
import useInfinityMessengerQuery from "../../../_hooks/useInfinityMessengerQuery";
import { Spinner } from "@/components/ui/spinner";
import { cn } from "@/lib/cn";

export default function MessengerBox({ clientId }: { clientId: number }) {
  const {
    data,
    isLoading,
    isError,
    ...
    hasNextPage,
    fetchNextPage,
  } = useInfinityMessengerQuery(clientId);
