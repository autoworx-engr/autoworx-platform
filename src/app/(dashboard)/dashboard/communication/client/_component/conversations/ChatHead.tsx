...
import { AtSign, MessageCircleMore, Phone } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
  ...
  return (
    <>
      ...
      >
        {renderEmailButton()}
        {renderSmsButton()}
        {isMessengerAccess?.enabled && renderMessengerButton()}
        {isInstagramAccess?.enabled && renderInstagramButton()}
        {isCallingAccess?.enabled && renderPhoneButton()}
      </div>

      {/* Mobile: collapsed behind a single trigger */}
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button
              ...
              title="Channels"
              aria-label="Conversation channels"
              className="relative rounded-full p-2 transition-all hover:bg-white/15 focus:outline-none focus:ring-2 focus:ring-white/70"
            >
              {hasAnyUnread && (
          ...
          <DropdownMenuContent
            align="end"
            className="w-auto rounded-2xl border-none bg-gradient-to-r from-[#006D77] to-[#008c99] p-1.5 shadow-xl"
          >
            <div
            ...
            >
              <DropdownMenuItem
                asChild
                className="rounded-full p-0 focus:bg-transparent"
              >
                {renderEmailButton()}
              </DropdownMenuItem>
              <DropdownMenuItem
