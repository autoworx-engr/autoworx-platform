...
import { Search as SearchIcon, MailWarning, Loader2 } from "lucide-react"; // Import for premium input
      ...
      {!hasMessagePermission ? (
        ...
        <>
          ...
          >
            <InfiniteScroll
              dataLength={
                clientMessages.length + filteredInternalMessages.length
              }
              next={fetchMoreClients}
              hasMore={!search && hasMore}
              loader={
                <div className="flex justify-center py-4">
                  <Loader2 className="w-6 h-6 animate-spin text-[#6571FF]" />
                </div>
              }
