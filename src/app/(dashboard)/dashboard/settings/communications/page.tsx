          ...
          <div className="space-y-8 rounded-sm border p-5">
            <div className="grid grid-cols-2 items-start space-x-3">
              <SlimInput
                ...
                value={company?.googleEmail ?? ""}
                disabled
              />
            </div>
            <div className="mt-8">
              <ConnectGoogle company={company} />
            </div>
          </div>
        </div>
...
'
                  className="h-[153px] w-full resize-none rounded-sm border border-primary-foreground bg-background px-2 py-0.5 text-sm leading-6 outline-none"
                />
              </label>
            </div>
