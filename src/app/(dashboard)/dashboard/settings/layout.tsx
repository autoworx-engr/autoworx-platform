  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      ...
      <div className="flex flex-col xl:flex-row xl:space-x-8">
        ...
        <div className="xl:w-[320px] xl:shrink-0 xl:sticky xl:top-0 h-fit">
          <Sidebar isLegacy={isLegacy} />
        </div>

        {/* Content area takes the remaining space */}
        <main className="w-full min-h-[70vh] rounded-xl bg-white p-4 sm:p-6 xl:p-8 shadow-md xl:mt-0 mt-4">
          {children}
        </main>
      </div>
    </div>
