      ...
      <div className="select-wrapper flex flex-col gap-3 md:flex-row md:items-end">
        <div className="flex-grow">
          ...
          <TimezoneSelect
            ...
            classNames={{
              control: () => 'py-1 px-3 border-2 border-[#6571FF] rounded-3xl shadow-sm bg-white focus:ring-2 focus:ring-[#6571FF] transition-all duration-150 flex items-center min-h-[36px]',
              option: ({ isSelected, isFocused }) => [
                'px-4 py-2 cursor-pointer transition-colors duration-100',
                isSelected ? 'bg-[#6571FF] text-white' : isFocused ? 'bg-blue-50 text-[#6571FF]' : 'text-gray-700',
              ].join(' '),
              menuList: () => 'max-h-60 overflow-y-auto thin-scrollbar bg-white rounded-lg shadow-lg border border-gray-200',
            ...
            styles={{
              ...
              control: (base: any, state: any) => ({
                ...
                boxShadow: state.isFocused ? '0 0 0 2px #6571FF33' : base.boxShadow,
                background: 'white',
