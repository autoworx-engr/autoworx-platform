    ...
    <div className="min-h-screen">
      <div className="relative -top-10 m-2 flex flex-col items-center space-y-2 overflow-hidden p-2">
        ...
        <div className="mb-2 mt-10 w-[762px]">
          ...
          <div className="flex gap-4 rounded-[5px] border border-[#D9D9D9] bg-background p-6">
        ...
        <div className="mb-4 w-[762px]">
          ...
          <div className="flex space-x-4">
            ...
            <div className="flex h-[131px] w-[147px] items-center justify-center rounded-[5px] border border-[#D9D9D9] bg-background">
        ...
        <div className="mt-4 w-[762px]">
          ...
          <div className="max-h-[270px] overflow-x-auto rounded-[5px] border border-[#D9D9D9] bg-background p-4">
