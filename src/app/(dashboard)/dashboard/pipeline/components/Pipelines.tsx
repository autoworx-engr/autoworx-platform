...
export default function Pipelines({
  ...
  const handleDragEnd = async (result: any) => {
    ...
    if (destinationColumn && destinationColumn.title === "Delivered") {
      ...
      console.log({ removed: removed.services });
      console.log({ technicians: removed.technicians });
  ...
  console.log("loading from timeline", loading);
  return (
    <>
                ...
                >
                  {(provided) => (
                    <div
                      ...
                      className="mx-2 flex-shrink-0 w-[calc(100vw-2rem)] sm:min-w-80 sm:flex-1 rounded-md border lg:min-w-[calc(100%/6-1.5rem)]"
                      style={{
