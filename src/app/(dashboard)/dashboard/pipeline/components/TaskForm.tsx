...
import AssignTaskDropDown from "@/app/(dashboard)/dashboard/task/[type]/components/task/AssignTaskDropDown";
import {
  Dialog,
  DialogClose,
  DialogContent,
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger>
        {path?.includes("sales") ? (
          ...
          <span className="rounded-md border-2 border-[#66738C] px-2 text-sm text-gray-500 duration-300 hover:bg-[#6571FF] hover:text-white">
            Add Task
          </span>
        )}
