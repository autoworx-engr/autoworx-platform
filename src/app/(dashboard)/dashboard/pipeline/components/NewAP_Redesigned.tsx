...
// export function NewAppointment_Redesigned({
//   clientId,
//   vehicleId,
// }: {
...
//   const [employeesToDisplay, setEmployeesToDisplay] = useState<User[] | null>(
//     newAppointmentData?.employees?.length ? newAppointmentData.employees : null,
//   );
//   const [client, setClient] = useState<Client | null>(
//     newAppointmentData?.client ? newAppointmentData.client : null,
//   );
//   const [clients, setClients] = useState<Client[] | null>(
//     newAppointmentData?.clients?.length ? newAppointmentData.clients : null,
//   );
//   const [vehicle, setVehicle] = useState<Vehicle | null>(
//     newAppointmentData?.vehicle ? newAppointmentData.vehicle : null,
//   );
//   const [vehicles, setVehicles] = useState<Vehicle[] | null>(
//     newAppointmentData?.vehicles ? newAppointmentData.vehicles : null,
//   );
//   const [assignedUsers, setAssignedUsers] = useState<User[]>([]);
//   const [employees, setEmployees] = useState<User[] | null>(
//     newAppointmentData?.employees?.length ? newAppointmentData.employees : null,
//   );
//   const [estimates, setEstimates] = useState<Invoice[] | null>(
//     newAppointmentData?.estimates?.length ? newAppointmentData.estimates : null,
//   );
//   const [templates, setTemplates] = useState<EmailTemplate[] | null>(
//     newAppointmentData?.templates?.length ? newAppointmentData.templates : null,
//   );
//   const [settings, setSettings] = useState<CalendarSettings | null>(
//     newAppointmentData?.settings ? newAppointmentData.settings : null,
//   );
...
//       setClients(newAppointmentData?.clients);
//       setVehicles(newAppointmentData?.vehicles);
//       setEmployees(newAppointmentData?.employees);
//       setTemplates(newAppointmentData?.templates);
//       setEstimates(newAppointmentData?.estimates);
//       setClient(newAppointmentData?.client);
//       setVehicle(newAppointmentData?.vehicle);
//       setSettings(newAppointmentData?.settings);
//     }
//   }, [newAppointmentData]);
