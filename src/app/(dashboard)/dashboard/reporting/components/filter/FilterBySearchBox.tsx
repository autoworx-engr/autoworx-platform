  ...
  return (
    <div className="relative w-full min-w-[300] max-w-[693px]">
      ...
      <input
        ...
        value={searchTerm}
        className="w-full truncate border border-slate-300 ring-0 rounded-xl bg-transparent pr-3 pl-10 py-2 text-slate-600 dark:text-slate-200 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary focus:shadow-[0_8px_24px_rgba(101,113,255,0.08)] transition-all duration-300"
        type="text"
