  ...
  return (
    ...
    <form className="mx-auto mt-56 max-w-md rounded-md border p-6">
      ...
      <Link
        ...
        className="block rounded-md px-2 py-2 text-right text-sm text-blue-500 underline hover:text-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
      >
        Forgot Password?
      </Link>
