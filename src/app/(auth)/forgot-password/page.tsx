      ...
      <form className="relative w-full max-w-md overflow-hidden rounded-2xl border border-white/30 bg-white/80 p-8 shadow-2xl backdrop-blur-2xl dark:bg-slate-900/90 dark:border-slate-700/50">
        ...
        <div className="mb-8 text-center flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-slate-600 dark:text-slate-400">
            Enter the email you use for this CRM. We will send a secure link to create a new password.
          </p>
        </div>
        ...
        <div className="mt-6 text-center text-sm text-slate-600 dark:text-slate-400">
          ...
          <Link
            href="/login"
            className="font-semibold text-[#0d9488] transition-colors hover:text-[#0f766e] hover:underline"
          >
            Back to login
          </Link>
        </div>
