...
const stepOrder: BookingStep[] = ['services', 'datetime', 'checkout', 'confirmation'];
          ...
          <div key={s.key} className="flex items-center flex-1 last:flex-none">
            <div className="flex flex-col items-center">
              <div className={cn(
                ...
                isActive && 'bg-accent text-accent-foreground ring-2 ring-accent ring-offset-2 ring-offset-background',
