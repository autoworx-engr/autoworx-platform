...
>(function BugReportDropdownCard(
  ...
  return createPortal(
    <Card
      ref={ref}
      className="fixed top-14 right-10 sm:top-16 md:right-32 z-30 flex w-72 sm:w-80 max-h-80 flex-col overflow-hidden shadow-xl"
    >
      {/* Header */}
      <CardHeader
        className={`shrink-0 pb-2 ${!isAdmin ? "flex flex-col gap-2 md:flex-row md:items-center md:justify-between" : ""}`}
      >
