...
export function CompanyCard({ company, rightSlot }: any) {
  return (
    <div className="flex items-center gap-3 rounded-xl border border-gray-100 bg-white px-3.5 py-3 shadow-sm hover:border-[#6571FF]/30 hover:shadow-md transition-all duration-150">
