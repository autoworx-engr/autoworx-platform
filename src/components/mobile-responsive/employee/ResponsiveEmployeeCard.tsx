    ...
    >
      ...
      <CardContent className="p-4 pt-0">
        <div className="mt-4 flex items-end justify-between">
          <div>
            <div >
              <a href={`mailto:${clientEmail}`} className="line-clamp-1 text-blue-500 hover:text-blue-700">{clientEmail}</a>
            </div>
            <div  >
              <a href={`tel:${clientPhone}`} className="line-clamp-1 text-blue-500 hover:text-blue-700">{clientPhone}</a>
            </div>
          </div>
