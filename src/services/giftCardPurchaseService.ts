        ...
        const emailHtml = `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e5e7eb; border-radius: 8px; overflow: hidden;">
            <div style="background-color: #2563eb; color: white; padding: 24px; text-align: center;">
              <h1 style="margin: 0; font-size: 24px;">$${input.amount} Gift Card</h1>
              <p style="margin: 8px 0 0; opacity: 0.9; font-weight: bold;">Valid at: ${context.shop.company.name || "Our Shop"}</p>
            </div>
            <div style="padding: 32px 24px;">
              <p style="font-size: 16px; color: #374151; margin-top: 0;">${greeting} Gift Card!</p>
              ${input.message ? `<blockquote style="border-left: 4px solid #e5e7eb; padding-left: 16px; margin: 24px 0; color: #4b5563; font-style: italic;">"${input.message}"</blockquote>` : ""}
