 ...
 * Generated: 2026-06-09T15:06:26.527Z
 * Source: src/app
 */
...
export const generatedRegistry: SearchItem[] = [
  {
    id: "api-docs",
    label: "Zapier API Documentation",
    href: "/api-docs",
    type: "page",
    keywords: ["api docs", "zapier", "api", "documentation"],
    description:
  ...
  },
  {
    ...
    href: "/api-docs/v1",
    type: "page",
    keywords: ["api docs", "api", "documentation"],
    description:
      "Explore and test the Autoworx API endpoints and integrations.",
  },
  {
    id: "dashboard",
    label: "Dashboard",
  ...
  },
  {
    ...
    type: "page",
    keywords: ["dashboard", "employee", "converted"],
  },
  {
  ...
  {
    id: "dashboard-estimate-edit-[id]",
    label: "Edit Estimate",
    href: "/dashboard/estimate/edit/[id]",
    type: "page",
    keywords: ["dashboard", "estimate", "edit"],
  ...
  {
    id: "dashboard-estimate-view-[id]",
    label: "Dashboard › Estimate › View",
    href: "/dashboard/estimate/view/[id]",
    type: "page",
    keywords: ["dashboard", "estimate", "view"],
  },
  {
    id: "dashboard-fleet",
  ...
  },
  {
    ...
    label: "Fleet Details",
    href: "/dashboard/fleet/[id]",
    type: "page",
    keywords: ["dashboard", "fleet", "details"],
  ...
  {
    id: "dashboard-inventory-use-[id]",
    label: "Inventory - Product",
    href: "/dashboard/inventory/use/[id]",
    type: "page",
    keywords: ["dashboard", "inventory", "product"],
  ...
  {
    id: "dashboard-inventory-vendor-[id]-history",
    label: "Inventory - Vendor Purchase History",
    href: "/dashboard/inventory/vendor/[id]/history",
    type: "page",
    keywords: ["dashboard", "inventory", "vendor", "history", "purchase"],
  ...
  },
  {
    ...
    href: "/dashboard/reporting/leads",
    type: "page",
  ...
  },
  {
    ...
    href: "/dashboard/reporting/revenue",
    type: "page",
  ...
  {
    id: "dashboard-settings-virtual-shop-configure-shops-[id]",
    label: "Settings - Update Shop",
    href: "/dashboard/settings/virtual-shop-configure/shops/[id]",
    type: "settings",
    keywords: [
      "dashboard",
      "settings",
  ...
  {
    id: "dashboard-task-v1-[type]",
    label: "Task and Activity Management",
    href: "/dashboard/task-v1/[type]",
    type: "page",
    keywords: ["dashboard", "task v1", "task", "activity", "management"],
    description: "Task and Activity Management",
  },
  {
    id: "dashboard-task-[type]",
    label: "Task & Activity Management",
    href: "/dashboard/task/[type]",
    type: "page",
    keywords: ["dashboard", "task", "activity", "management"],
  ...
  {
    id: "dashboard-virtual-shop-admin-[shopId]-calendar",
    label: "Shop Booking Calendar",
    href: "/dashboard/virtual-shop/admin/[shopId]/calendar",
    type: "page",
    keywords: [
      "dashboard",
      "virtual shop",
  ...
  {
    id: "dashboard-virtual-shop-admin-[shopId]-deposits",
    label: "Virtual Shop Deposits",
    href: "/dashboard/virtual-shop/admin/[shopId]/deposits",
    type: "page",
    keywords: [
      "dashboard",
      "virtual shop",
  ...
  {
    id: "dashboard-virtual-shop-admin-[shopId]-estimates",
    label: "Virtual Shop Estimates",
    href: "/dashboard/virtual-shop/admin/[shopId]/estimates",
    type: "page",
    keywords: [
      "dashboard",
      "virtual shop",
  ...
  {
    id: "dashboard-virtual-shop-admin-[shopId]-financial",
    label: "Virtual Shop Financial",
    href: "/dashboard/virtual-shop/admin/[shopId]/financial",
    type: "page",
    keywords: [
      "dashboard",
      "virtual shop",
  ...
  {
    id: "dashboard-virtual-shop-admin-[shopId]-gift-card-purchases",
    label: "Gift Card Purchases",
    href: "/dashboard/virtual-shop/admin/[shopId]/gift-card-purchases",
    type: "page",
    keywords: [
      "dashboard",
      "virtual shop",
  ...
  {
    id: "dashboard-virtual-shop-admin-[shopId]-gift-cards",
    label: "Virtual Shop Gift Cards",
    href: "/dashboard/virtual-shop/admin/[shopId]/gift-cards",
    type: "page",
    keywords: [
      "dashboard",
      "virtual shop",
  ...
  {
    id: "dashboard-virtual-shop-admin-[shopId]-scheduling",
    label: "Virtual Shop Scheduling",
    href: "/dashboard/virtual-shop/admin/[shopId]/scheduling",
    type: "page",
    keywords: [
      "dashboard",
      "virtual shop",
    ...
    description:
      "View and manage your virtual shop scheduling and availability.",
  },
  {
    id: "dashboard-virtual-shop-admin-[shopId]-services",
    label: "Virtual Shop Services",
    href: "/dashboard/virtual-shop/admin/[shopId]/services",
    type: "page",
    keywords: [
      "dashboard",
      "virtual shop",
  ...
  {
    id: "dashboard-virtual-shop-admin-[shopId]-urgent-requests",
    label: "Virtual Shop - Urgent Requests",
  ...
  {
    id: "dashboard-virtual-shop-admin-[shopId]-urgent-requests-[id]",
    label: "Virtual Shop - Urgent Request Detail",
    href: "/dashboard/virtual-shop/admin/[shopId]/urgent-requests/[id]",
    type: "page",
    keywords: [
      "dashboard",
      "virtual shop",
