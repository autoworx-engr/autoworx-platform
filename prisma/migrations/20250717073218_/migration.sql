...
CREATE TABLE `Appointment` (
    ...
    INDEX `fk_tasks_client`(`customer_id`),
...
CREATE TABLE `AppointmentUser` (
    ...
    INDEX `AppointmentUser_appointment_id_idx`(`appointment_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `PipelineAutomationRule` (
    ...
    `conditionType` ENUM('APPOINTMENT_SCHEDULED', 'ESTIMATE_CREATED', 'TASK_CREATED', 'MESSAGE_SENT_CLIENT', 'MESSAGE_RECEIVED_CLIENT', 'TIME_DELAY') NOT NULL,
    `targetColumnId` INTEGER NULL,
    `isPaused` BOOLEAN NOT NULL DEFAULT false,
    `timeDelay` INTEGER NULL,
    `companyId` INTEGER NOT NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,

    INDEX `PipelineAutomationRule_companyId_idx`(`companyId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `PipelineStage` (
    ...
    INDEX `PipelineStage_pipelineRuleId_idx`(`pipelineRuleId`),
    UNIQUE INDEX `PipelineStage_pipelineRuleId_columnId_key`(`pipelineRuleId`, `columnId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `TimeDelayExecution` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `pipelineRuleId` INTEGER NULL,
    `communicationRuleId` INTEGER NULL,
    `leadId` INTEGER NULL,
    `estimateId` VARCHAR(191) NULL,
    `serviceMaintenanceRuleId` INTEGER NULL,
    `invoiceAutomationRuleId` INTEGER NULL,
    ...
    `inventoryAutomationRuleId` INTEGER NULL,

    INDEX `TimeDelayExecution_executeAt_status_idx`(`executeAt`, `status`),
    INDEX `TimeDelayExecution_pipelineRuleId_idx`(`pipelineRuleId`),
    INDEX `TimeDelayExecution_communicationRuleId_idx`(`communicationRuleId`),
    INDEX `TimeDelayExecution_leadId_idx`(`leadId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `CommunicationAutomationRule` (
    ...
    `targetColumnId` INTEGER NULL,
    `communicationType` ENUM('SMS', 'EMAIL', 'BOTH') NOT NULL,
    `isSendWeekDays` BOOLEAN NOT NULL DEFAULT false,
    `templateType` ENUM('SMS', 'EMAIL') NOT NULL,
...
CREATE TABLE `CommunicationStage` (
    ...
    INDEX `CommunicationStage_communicationRuleId_idx`(`communicationRuleId`),
    UNIQUE INDEX `CommunicationStage_communicationRuleId_columnId_key`(`communicationRuleId`, `columnId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `MarketingAutomationRule` (
    ...
    `targetCondition` ENUM('ALL_CLIENTS_THIS_MONTH', 'ALL_CLIENTS_THIS_YEAR', 'ALL_CLIENTS_FROM_1_MONTH', 'ALL_CLIENTS_FROM_2_MONTHS', 'ALL_CLIENTS_FROM_3_MONTHS', 'ALL_CLIENTS_FROM_6_MONTHS', 'ALL_CLIENTS_FROM_LAST_YEAR') NOT NULL,
    `date` DATETIME(3) NOT NULL,
    `startTime` DATETIME(3) NOT NULL,
    `isAppointmentCreated` BOOLEAN NOT NULL DEFAULT false,
    `vehicleMinYear` VARCHAR(191) NULL,
    `vehicleMaxYear` VARCHAR(191) NULL,
...
CREATE TABLE `ServiceMaintenanceAutomationRule` (
    ...
    `companyId` INTEGER NOT NULL,
    `title` VARCHAR(191) NOT NULL,
    `conditionColumnId` INTEGER NOT NULL,
    `isPaused` BOOLEAN NOT NULL DEFAULT false,
    `timeDelay` INTEGER NULL,
    `targetColumnId` INTEGER NULL,
    `templateType` ENUM('SMS', 'EMAIL') NOT NULL DEFAULT 'SMS',
    `emailSubject` VARCHAR(191) NULL,
    `emailBody` TEXT NULL,
    `smsBody` TEXT NULL,
    `createdBy` VARCHAR(191) NULL,
...
CREATE TABLE `ServiceMaintenanceStage` (
    ...
    INDEX `ServiceMaintenanceStage_serviceMaintenanceRuleId_idx`(`serviceMaintenanceRuleId`),
    UNIQUE INDEX `ServiceMaintenanceStage_serviceMaintenanceRuleId_serviceId_key`(`serviceMaintenanceRuleId`, `serviceId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- CreateTable
CREATE TABLE `InventoryAutomationRule` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `title` VARCHAR(191) NOT NULL,
    `companyId` INTEGER NOT NULL,
    `frequency` ENUM('DAILY', 'WEEKLY', 'MONTHLY', 'EVERY_TWO_MONTHS') NOT NULL,
    `day` ENUM('MONDAY', 'TUESDAY', 'WEDNESDAY', 'THURSDAY', 'FRIDAY', 'SATURDAY', 'SUNDAY') NULL,
    `condition` ENUM('LOW_STOCK', 'OUT_OF_STOCK', 'BOTH') NOT NULL,
    `action` ENUM('EMAIL', 'SMS', 'BOTH') NOT NULL,
    `isPaused` BOOLEAN NOT NULL DEFAULT false,
    `createdBy` VARCHAR(191) NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,

    INDEX `InventoryAutomationRule_companyId_idx`(`companyId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- CreateTable
CREATE TABLE `InventoryAutomationTeamMember` (
    `inventoryRuleId` INTEGER NOT NULL,
    `userId` INTEGER NOT NULL,

    PRIMARY KEY (`inventoryRuleId`, `userId`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `AutomationAttachment` (
    ...
    `communicationId` INTEGER NULL,
    `marketingId` INTEGER NULL,
    `serviceMaintenanceId` INTEGER NULL,
...
CREATE TABLE `Client` (
    ...
    `is_fleet` BOOLEAN NULL DEFAULT false,
...
CREATE TABLE `Fleet` (
    ...
    `fleetName` VARCHAR(191) NOT NULL,
    `contactName` VARCHAR(191) NOT NULL,
    `preferred_payment_term` VARCHAR(191) NULL,
    `created_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updated_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),

    UNIQUE INDEX `Fleet_client_id_key`(`client_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- CreateTable
CREATE TABLE `FleetStatement` (
...
CREATE TABLE `CalendarSettings` (
    ...
    INDEX `CalendarSettings_company_id_idx`(`company_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Holiday` (
    ...
    INDEX `Holiday_company_id_idx`(`company_id`),
    INDEX `Holiday_month_idx`(`month`),
    INDEX `Holiday_year_idx`(`year`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `EmailTemplate` (
    ...
    INDEX `EmailTemplate_company_id_idx`(`company_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Lead` (
    ...
    INDEX `Lead_vehicleId_idx`(`vehicleId`),
    INDEX `Lead_column_id_idx`(`column_id`),
    INDEX `Lead_company_id_idx`(`company_id`),
    INDEX `Lead_assigned_sales_id_idx`(`assigned_sales_id`),
    INDEX `Lead_client_email_idx`(`client_email`),
    INDEX `Lead_column_changed_at_idx`(`column_changed_at`),
    INDEX `Lead_isEstimateCreated_idx`(`isEstimateCreated`),
    INDEX `Lead_created_at_idx`(`created_at`),
    INDEX `Lead_company_id_column_id_idx`(`company_id`, `column_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `LeadLink` (
    ...
    INDEX `LeadLink_companyId_idx`(`companyId`),
    UNIQUE INDEX `LeadLink_source_companyId_shortUrl_key`(`source`, `companyId`, `shortUrl`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Column` (
    ...
    INDEX `Column_company_id_idx`(`company_id`),
    INDEX `Column_type_idx`(`type`),
    INDEX `Column_type_company_id_idx`(`type`, `company_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `inventoryWirehouseProduct` (
    ...
    UNIQUE INDEX `inventoryWirehouseProduct_productName_key`(`productName`),
    INDEX `inventoryWirehouseProduct_productName_idx`(`productName`),
    INDEX `inventoryWirehouseProduct_category_idx`(`category`),
    INDEX `inventoryWirehouseProduct_unit_idx`(`unit`),
    INDEX `inventoryWirehouseProduct_category_productName_idx`(`category`, `productName`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Service` (
    ...
    `canned` BOOLEAN NULL DEFAULT false,
    `from_request` BOOLEAN NULL DEFAULT false,
    `from_requested_company_id` INTEGER NULL,
    `category_id` INTEGER NULL,
    `company_id` INTEGER NOT NULL,
...
CREATE TABLE `Tag` (
    ...
    `textColor` VARCHAR(191) NOT NULL,
    `bgColor` VARCHAR(191) NOT NULL,
    `type` ENUM('GENERAL', 'SALES', 'CLIENT', 'INVENTORY') NOT NULL DEFAULT 'GENERAL',
    `created_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updated_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `company_id` INTEGER NOT NULL,

    INDEX `Tag_company_id_type_idx`(`company_id`, `type`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `InvoiceInspection` (
    ...
    INDEX `fk_invoice_inspections_invoice`(`invoice_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Message` (
    ...
    `section` ENUM('internal', 'collaboration') NULL,
    `request_estimate_id` INTEGER NULL,
    `created_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updated_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
...
CREATE TABLE `NotificationSettingsV2` (
    ...
    `company_id` INTEGER NOT NULL,
    `user_id` INTEGER NOT NULL,
    `section` ENUM('CALENDAR_AND_TASK', 'LEAD_GENERATED_AND_SALES_PIPELINE', 'ESTIMATE_AND_INVOICE', 'PAYMENT', 'OPERATION_PIPELINE', 'INVENTORY', 'WORK_FORCE', 'COMMUNICATIONS') NOT NULL,
    `notification_type` ENUM('TASK_ASSIGNED', 'TASK_FINISHED', 'APPOINTMENT_CREATED', 'APPOINTMENT_REMINDER', 'APPOINTMENT_UPDATED', 'TASK_REMINDER', 'LEADS_GENERATED', 'LEADS_CLOSED', 'FOLLOW_UP', 'LEADS_ASSIGNED', 'STAGE', 'ESTIMATE_CREATED', 'INVOICE_CREATED', 'INVOICE_DELIVERY', 'INVOICE_CONVERTED', 'INVOICE_AUTHORIZED', 'PAYMENT_RECEIVED', 'PAYMENT_DUE', 'DEPOSIT', 'WORK_ORDER_CREATED', 'WORK_ORDER_COMPLETED', 'DUE_DATE_PROXIMITY', 'INVENTORY_COMPLETELY_OUT', 'INVENTORY_NEWLY_ADDED', 'INVENTORY_LOW', 'LEAVE_REQUEST', 'PERFORMANCE_CHANGES', 'LATE_ARRIVALS', 'EARLY_LEAVE', 'JOB_COMPLETED', 'JOB_ASSIGNED', 'INTERNAL_MESSAGE_ALERT', 'CLIENT_MESSAGE_ALERT', 'CLIENT_CALL_ALERT', 'CLIENT_EMAIL_ALERT', 'COLLABORATION_MESSAGE_ALERT') NOT NULL,
    ...
    UNIQUE INDEX `NotificationSettingsV2_user_id_notification_type_key`(`user_id`, `notification_type`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Payment` (
    ...
    `refunded_amount` DECIMAL(65, 30) NULL DEFAULT 0,
    `refund_method` ENUM('CARD', 'CHECK', 'CASH', 'OTHER', 'DEPOSIT') NULL,
    `refund_reason` VARCHAR(191) NULL,
    `type` ENUM('CARD', 'CHECK', 'CASH', 'OTHER', 'DEPOSIT') NOT NULL,
    `invoice_id` VARCHAR(191) NULL,
    `company_id` INTEGER NOT NULL,
    `refund_created_at` DATETIME(3) NULL,
    `refund_updated_at` DATETIME(3) NULL,
    `created_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updated_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    ...
    INDEX `Payment_amount_idx`(`amount`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `refunds` (
    ...
    `method` ENUM('CARD', 'CHECK', 'CASH', 'OTHER', 'DEPOSIT') NOT NULL,
    `refund_date` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `notes` VARCHAR(191) NULL,
...
CREATE TABLE `DepositPayment` (
    ...
    `depositNotes` VARCHAR(191) NULL,

    UNIQUE INDEX `DepositPayment_paymentId_key`(`paymentId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `StripePayment` (
    ...
    UNIQUE INDEX `StripePayment_stripe_payment_intent_id_key`(`stripe_payment_intent_id`),
    UNIQUE INDEX `StripePayment_payment_id_key`(`payment_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `TaskUser` (
    ...
    INDEX `TaskUser_task_id_idx`(`task_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `ClientCall` (
    ...
    `recordingSid` VARCHAR(191) NULL,
    `callStartTime` DATETIME(3) NULL,
    `callEndTime` DATETIME(3) NULL,
    `sentBy` ENUM('Client', 'Company') NOT NULL,
    `user_id` INTEGER NULL,
    `company_id` INTEGER NOT NULL,
    `client_id` INTEGER NOT NULL,
    ...
    UNIQUE INDEX `ClientCall_callSid_key`(`callSid`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `TimeDelayExecution` ADD CONSTRAINT `TimeDelayExecution_estimateId_fkey` FOREIGN KEY (`estimateId`) REFERENCES `Invoice`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `TimeDelayExecution` ADD CONSTRAINT `TimeDelayExecution_invoiceAutomationRuleId_fkey` FOREIGN KEY (`invoiceAutomationRuleId`) REFERENCES `InvoiceAutomationRule`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `TimeDelayExecution` ADD CONSTRAINT `TimeDelayExecution_inventoryAutomationRuleId_fkey` FOREIGN KEY (`inventoryAutomationRuleId`) REFERENCES `InventoryAutomationRule`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `ServiceMaintenanceAutomationRule` ADD CONSTRAINT `ServiceMaintenanceAutomationRule_conditionColumnId_fkey` FOREIGN KEY (`conditionColumnId`) REFERENCES `Column`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `InvoiceAutomationRule` ADD CONSTRAINT `InvoiceAutomationRule_invoiceStatusId_fkey` FOREIGN KEY (`invoiceStatusId`) REFERENCES `Column`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `InvoiceAutomationRule` ADD CONSTRAINT `InvoiceAutomationRule_companyId_fkey` FOREIGN KEY (`companyId`) REFERENCES `Company`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `InvoiceAutomationRule` ADD CONSTRAINT `InvoiceAutomationRule_columnId_fkey` FOREIGN KEY (`columnId`) REFERENCES `Column`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `InventoryAutomationRule` ADD CONSTRAINT `InventoryAutomationRule_companyId_fkey` FOREIGN KEY (`companyId`) REFERENCES `Company`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `InventoryAutomationTeamMember` ADD CONSTRAINT `InventoryAutomationTeamMember_inventoryRuleId_fkey` FOREIGN KEY (`inventoryRuleId`) REFERENCES `InventoryAutomationRule`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `InventoryAutomationTeamMember` ADD CONSTRAINT `InventoryAutomationTeamMember_userId_fkey` FOREIGN KEY (`userId`) REFERENCES `User`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `Fleet` ADD CONSTRAINT `Fleet_client_id_fkey` FOREIGN KEY (`client_id`) REFERENCES `Client`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `FleetStatement` ADD CONSTRAINT `FleetStatement_fleet_id_fkey` FOREIGN KEY (`fleet_id`) REFERENCES `Fleet`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `Invoice` ADD CONSTRAINT `Invoice_fleetStatementId_fkey` FOREIGN KEY (`fleetStatementId`) REFERENCES `FleetStatement`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `refunds` ADD CONSTRAINT `refunds_invoice_id_fkey` FOREIGN KEY (`invoice_id`) REFERENCES `Invoice`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `refunds` ADD CONSTRAINT `refunds_company_id_fkey` FOREIGN KEY (`company_id`) REFERENCES `Company`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `refunds` ADD CONSTRAINT `refunds_processed_by_fkey` FOREIGN KEY (`processed_by`) REFERENCES `User`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
