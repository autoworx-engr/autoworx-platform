...
-- CreateIndex
CREATE INDEX "Lead_company_id_column_id_idx" ON "Lead"("company_id", "column_id");
...
-- CreateIndex
CREATE INDEX "Column_type_idx" ON "Column"("type");

-- CreateIndex
CREATE INDEX "Column_type_company_id_idx" ON "Column"("type", "company_id");
...
-- CreateIndex
CREATE INDEX "Invoice_company_id_type_idx" ON "Invoice"("company_id", "type");
